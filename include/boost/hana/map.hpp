...
BOOST_HANA_NAMESPACE_BEGIN
    ...
    namespace detail {
        ...
        struct map_from_indices_t {};
        struct map_from_tuple_indices_t {};
        ...
        , detail::operators::adl<map<Pairs...>>
    {
        ...
        template <typename Other, std::size_t ...i>
        constexpr map(detail::map_from_indices_t,
                std::index_sequence<i...>, Other&& other)
            : detail::map_impl<std::index_sequence<i...>, Pairs...>(
                detail::map_get_helper<i>(other)...)
        { }

        template <typename Tuple, std::size_t ...i>
        constexpr map(detail::map_from_tuple_indices_t,
                std::index_sequence<i...>, Tuple&& xs)
            : detail::map_impl<std::index_sequence<i...>, Pairs...>(
                hana::get_impl<i>(xs.storage_)...)
        { }
