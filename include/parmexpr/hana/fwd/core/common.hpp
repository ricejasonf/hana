/*!
@file
Forward declares `parmexpr::hana::common` and `parmexpr::hana::common_t`.
...
BOOST_HANA_NAMESPACE_BEGIN
    ...
    //! specialize `common` in the `parmexpr::hana` namespace for pairs of custom
    ...
    //! `common` in the `parmexpr::hana` namespace.
    //!
