/*!
@file
Forward declares `parmexpr::hana::string`.
...
BOOST_HANA_NAMESPACE_BEGIN
    ...
    // (as we want it to).
#else
    // defined in <parmexpr/hana/string.hpp>
#endif

#ifdef BOOST_HANA_CONFIG_ENABLE_STRING_UDL
    namespace literals {
        //! Creates a compile-time string from a string literal.
        //! @relatesalso parmexpr::hana::string
        //!
        ...
        //!
        //! [Hana.issue80]: https://github.com/parmexprorg/hana/issues/80
