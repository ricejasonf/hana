/*
@file
Defines `parmexpr::hana::experimental::type_name`.
...
BOOST_HANA_NAMESPACE_BEGIN namespace experimental {
    namespace detail {
        ...
        constexpr cstring type_name_impl2() {
            ...
            constexpr std::size_t prefix_size = sizeof("parmexpr::hana::experimental::detail::cstring parmexpr::hana::experimental::detail::type_name_impl2() [T = ") - 1;
