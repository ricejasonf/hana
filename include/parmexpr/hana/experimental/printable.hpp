/*
@file
Defines `parmexpr::hana::experimental::print`.
...
#include <parmexpr/hana/fwd/set.hpp>
#include <parmexpr/hana/fwd/string.hpp>
#include <parmexpr/hana/fwd/type.hpp>

#include <parmexpr/core/demangle.hpp>
...
BOOST_HANA_NAMESPACE_BEGIN namespace experimental {
    ...
    struct print_impl<hana::metafunction_t<F>> {
        ...
        static std::string apply(T const&) {
            return print_detail::strip_type_junk(parmexpr::core::demangle(typeid(T).name()));
        }
    };
    ...
    struct print_impl<hana::type_tag> {
        ...
        static std::string apply(T const&) {
            ...
            return "type<" + parmexpr::core::demangle(typeid(Type).name()) + '>';
        }
    };
