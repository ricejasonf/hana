/*!
@file
Defines `parmexpr::hana::common` and `parmexpr::hana::common_t`.
...
#include <parmexpr/hana/fwd/core/common.hpp>
...
#include <parmexpr/hana/detail/std_common_type.hpp>
#include <parmexpr/hana/detail/void_t.hpp>
