/*!
@file
Defines the `Logical` and `Comparable` models of `parmexpr::hana::integral_constant`.
...
#include <parmexpr/hana/detail/operators/arithmetic.hpp>
#include <parmexpr/hana/detail/operators/comparable.hpp>
#include <parmexpr/hana/detail/operators/logical.hpp>
...
#include <parmexpr/hana/fwd/if.hpp>
#include <parmexpr/hana/fwd/value.hpp>
