/*!
@file
Defines `parmexpr::hana::greater_equal`.
...
#include <parmexpr/hana/fwd/greater_equal.hpp>
...
#include <parmexpr/hana/detail/concepts.hpp>
#include <parmexpr/hana/detail/has_common_embedding.hpp>
#include <parmexpr/hana/detail/nested_than.hpp> // required by fwd decl
